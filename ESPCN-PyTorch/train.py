...
def main():
    ...
    for epoch in range(start_epoch, config.epochs):
        ...
        # print(samples_dir)
        torch.save(espcn_model.state_dict(), os.path.join(samples_dir, f"g_epoch_{epoch + 1}.pth.tar"))
        break
...
def load_dataset(): # -> [CUDAPrefetcher, CUDAPrefetcher]:
    ...
    train_datasets = TrainValidImageFromVideoDataset(config.train_gt_images_dir,
                                            config.gt_image_size,
                                            config.upscale_factor,
                                            "Train")
    test_datasets = TrainValidImageFromVideoDataset(config.test_gt_images_dir,
                                            config.gt_image_size,
                                            config.upscale_factor,
                                            "Valid")
...
def train(
    ...
    for batch_data in train_prefetcher:
